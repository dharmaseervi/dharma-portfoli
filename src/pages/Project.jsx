...
const projects = [
  ...
  },
  {
    ...
    link: "https://mern-stack-ecommerce-orpin.vercel.app",
    description: `NextCart: Elevating E-commerce Experiences,
    Cutting-edge Technology: Built with Next.js, React, and Tailwind CSS,
    Dynamic Features: Seamlessly integrated cart functionality for smooth transactions,
    Secure Authentication: NextAuth for robust user authentication and authorization,
    Database Management: MongoDB for efficient data storage and retrieval,
    Payment Gateway Integration: Razorpay ensures secure and hassle-free transactions`,
    techStack: ["Nextjs", "React" ,"MongoDB","nodejs","TailwindCss"],
    category: "Web Development",
  },
];
